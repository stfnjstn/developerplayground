...
The update includes brand new 3D models for keys and key locks, available in both the Level Editor and the game. What makes these special is that they leverage the tinting system we introduced earlier - meaning you can create multiple different colored keys and matching locks!

<div style="display: flex; gap: 10px; margin: 20px 0;">
  <img src="/assets/2025/11/TintableKeys3.jpg" alt="Key and Lock System" style="width: 100%;">
</div>

<div style="display: flex; gap: 10px; margin: 20px 0;">
  <img src="/assets/2025/11/TintableKeys1.PNG" alt="Multiple Key Colors 1" style="width: 48%;">
  <img src="/assets/2025/11/TintableKeys2.PNG" alt="Multiple Key Colors 2" style="width: 48%;">
</div>
