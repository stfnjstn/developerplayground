...
Today I'll extend the parallax effect from [part 5](https://developerplayground.net/?p=26) of my posts with vertical scrolling. This should increase the illusion of depth. To control the movement I'll use the motion sensors as described in [part 6.](https://developerplayground.net/?p=25)
...
[![BackgroundBushiPad@2x](/assets/wp-content/uploads/2014/05/BackgroundBushiPad@2x-1-300x56.jpg)](/assets/wp-content/uploads/2014/05/BackgroundBushiPad@2x-1.jpg)

[![BackgroundTree@2x~ipad](/assets/wp-content/uploads/2014/05/BackgroundTree@2xipad-1-300x75.jpg)](/assets/wp-content/uploads/2014/05/BackgroundTree@2xipad-1.jpg)
...
The code changes should be straight forward: (If you haven't completed [ part 6](https://developerplayground.net/howto-use-the-device-motion-sensors-to-control-your-game/) you can download the project from GitHub: [ v0.5.1](https://github.com/stfnjstn/MyFirstGame/releases/tag/v0.6))
