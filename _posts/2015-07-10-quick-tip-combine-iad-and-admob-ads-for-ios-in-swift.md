...
#### Prerequisites for this tutorial:
  ...
  * You have a subscription for the Apple iAds program. For details please check my previous article about [iAD integration](https://developerplayground.net/how-to-implement-a-space-shooter-with-spritekit-and-swift-part-7-iad-integration/).
